...
echo -e $bu  " Tools       : CYBER SCERUTITI IND          " 
echo -e $bu  " Author      : WHITE HAT IND  " 
echo -e $bu  " Contact     : 083872066968 " 
...
echo -e $bu "pilih sesuai lo yak kontol==> otomatis Gagal <==[        Hahaha bau memek mkang recode:v]"
read -p "====>" pil  ;
...
0) echo -e $bu"KHO  -" 
echo -e $bu"THANK'S"
printf "\e[103m\e[1;77mBY; HAPID FERDIANSYAH GANS\e[0m\n"
sleep 2
exit
;;

*) echo "AKU JOMBLO ANJAY !!"  | lolcat
esac
done
done
